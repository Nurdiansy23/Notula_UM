  ...
  methods: {
    ...
    async beginTranscription(type = "single") {
      try {
        ...
        if (!key) throw new Error("Token Deepgram tidak ditemukan");

        const wsUrl =
          "wss://api.deepgram.com/v1/listen?model=nova-2&punctuate=true&diarize=true&diarize_speaker_count=18&smart_format=true&language=id";
